...
const TRANSLATIONS_META: Array<{
  ...
  { file: "ASV.json", abbreviation: "ASV", title: "American Standard Version", language: "en", license: "Public Domain" },
  { file: "NHEB.json", abbreviation: "NHEB", title: "New Heart English Bible", language: "en", license: "Public Domain" },
  { file: "YLT.json", abbreviation: "YLT", title: "Young's Literal Translation", language: "en", license: "Public Domain" },
  { file: "Darby.json", abbreviation: "Darby", title: "Darby Bible", language: "en", license: "Public Domain" },
  { file: "Webster.json", abbreviation: "Webster", title: "Webster's Bible", language: "en", license: "Public Domain" },
  { file: "DRC.json", abbreviation: "DRC", title: "Douay-Rheims", language: "en", license: "Public Domain" },
  { file: "Geneva1599.json", abbreviation: "Geneva1599", title: "Geneva Bible (1599)", language: "en", license: "Public Domain" },
  { file: "BBE.json", abbreviation: "BBE", title: "Bible in Basic English", language: "en", license: "Public Domain" },
  // Non-English
